...
bool registerBuiltins(RunCtx *runCtx) {
	...
	ObjClass *gmatchIteratorClass = registerStaticClass(runCtx, &gmatchIteratorName, &eloxBuiltinModule,
														objectClass, iteratorIntf, NULL);
	...
	ObjClass *stringClass = registerStaticClass(runCtx, &stringName, &eloxBuiltinModule,
												objectClass, NULL);
	...
	ObjClass *numberClass = registerStaticClass(runCtx, &numberName, &eloxBuiltinModule,
												objectClass, NULL);
	...
	ObjClass *boolClass = registerStaticClass(runCtx, &boolName, &eloxBuiltinModule,
											  objectClass, NULL);
	...
	ObjClass *instanceClass = registerStaticClass(runCtx, &instanceName, &eloxBuiltinModule,
												  objectClass, NULL);
	RET_IF_OOM(instanceClass);
	vm->builtins.instanceClass = instanceClass;

	const String className = ELOX_STRING("Class");
	ObjClass *classClass = registerStaticClass(runCtx, &className, &eloxBuiltinModule,
											   objectClass, NULL);
	RET_IF_OOM(classClass);
	vm->builtins.classClass = classClass;

	const String throwableName = ELOX_STRING("Throwable");
	ObjClass *throwableClass = registerStaticClass(runCtx, &throwableName, &eloxBuiltinModule,
												   objectClass, NULL);
	...
	ObjClass *exceptionClass = registerStaticClass(runCtx, &exceptionName, &eloxBuiltinModule,
												   throwableClass, NULL);
	...
	ObjClass *runtimeExceptionClass = registerStaticClass(runCtx, &runtimeExceptionName, &eloxBuiltinModule,
														  exceptionClass, NULL);
	...
	ObjClass *errorClass = REGISTER_STATIC_CLASS(runCtx, &errorName, &eloxBuiltinModule,
												 throwableClass);
	...
	ObjClass *arrayIteratorClass = registerStaticClass(runCtx, &arrayIteratorName, &eloxBuiltinModule,
													   objectClass, iteratorIntf, NULL);
	...
	ObjClass *arrayClass = registerStaticClass(runCtx, &arrayName, &eloxBuiltinModule,
											   objectClass, NULL);
	...
	ObjClass *tupleClass = registerStaticClass(runCtx, &tupleName, &eloxBuiltinModule,
											   objectClass, NULL);
	...
	ObjClass *hashMapIteratorClass = registerStaticClass(runCtx, &hashMapIteratorName, &eloxBuiltinModule,
														 objectClass, iteratorIntf, NULL);
	...
	ObjClass *hashMapClass = registerStaticClass(runCtx, &hashMapName, &eloxBuiltinModule,
												 objectClass, mapIntf, NULL);
