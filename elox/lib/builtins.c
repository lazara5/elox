...
static Value clockNative(VMCtx *vmCtx ELOX_UNUSED,
						int argCount ELOX_UNUSED, Value *args ELOX_UNUSED) {
	return NUMBER_VAL((double)clock() / CLOCKS_PER_SEC);
}

static Value printNative(VMCtx *vmCtx ELOX_UNUSED, int argCount, Value *args) {
...
static Value objectToString(VMCtx *vmCtx, int argCount ELOX_UNUSED, Value *args) {
	HeapCString ret;
...
static Value objectHashCode(VMCtx *vmCtx ELOX_UNUSED, int argCount ELOX_UNUSED, Value *args) {
	ObjInstance *inst = AS_INSTANCE(args[0]);
...
static Value stringToString(VMCtx *vmCtx ELOX_UNUSED, int argCount ELOX_UNUSED, Value *args) {
	ObjString *inst = AS_STRING(args[0]);
	return OBJ_VAL(inst);
}

static Value stringHashCode(VMCtx *vmCtx ELOX_UNUSED, int argCount ELOX_UNUSED, Value *args) {
	ObjString *inst = AS_STRING(args[0]);
...
static Value numberToString(VMCtx *vmCtx ELOX_UNUSED, int argCount ELOX_UNUSED, Value *args) {
...
static Value exceptionInit(VMCtx *vmCtx, int argCount ELOX_UNUSED, Value *args) {
	VM *vm = &vmCtx->vm;
	ObjInstance *inst = AS_INSTANCE(args[0]);
...
static Value arrayLength(VMCtx *vmCtx ELOX_UNUSED, int argCount ELOX_UNUSED, Value *args) {
...
static Value arrayIteratorFunc(VMCtx *vmCtx ELOX_UNUSED, int argCount ELOX_UNUSED,
							  Value *args ELOX_UNUSED, int numUpvalues ELOX_UNUSED,
							  Value *upvalues) {
...
static Value arrayIterator(VMCtx *vmCtx ELOX_UNUSED, int argCount ELOX_UNUSED, Value *args) {
	ObjArray *inst = AS_ARRAY(args[0]);
...
static Value mapSize(VMCtx *vmCtx ELOX_UNUSED, int argCount ELOX_UNUSED, Value *args) {
...
static Value mapIterator(VMCtx *vmCtx ELOX_UNUSED, int argCount ELOX_UNUSED, Value *args) {
	ObjMap *inst = AS_MAP(args[0]);
